...
namespace TMPT.DataClass
{
    class MyMeans
    {
        ...
        public static string M_str_sqlcon = "Data Source=WIN-NBO2JVGOUA2;Database=db_PWMS;User id=sa;PWD=";
        //public static string M_str_sqlcon = @"Data Source=MRDEL\SQLEXPRESS;Initial Catalog=db_PWMS;Integrated Security=True";

        public static int Login_n = 0;  //用户登录与重新登录的标识
        public static string AllSql = "Select * from tb_商标基本信息";    //存储职工基本信息表中的SQL语句
